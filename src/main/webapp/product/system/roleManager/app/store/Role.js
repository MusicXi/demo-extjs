Ext.define('RoleManager.store.Role', {
	extend: 'Ext.data.Store',
	model:'RoleManager.model.Role',//store的配置model必须要是类完整的名称,否则store对象无法引用到
	autoLoad:true,//自动载入
	//remoteFilter:true, 
	pageSize:15,	//设置分页大小
	proxy: {
		...
		api:{
			read:webRoot+'/product/system/roleManager/read.do',
			create:webRoot+'/product/system/roleManager/create.do',
			update:webRoot+'/product/system/roleManager/update.do',
