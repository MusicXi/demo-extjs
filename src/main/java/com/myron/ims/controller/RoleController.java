...
@Controller
@RequestMapping("/product/system/roleManager")
public class RoleController {
	...
	public  Map<String, Object>read(String filter, ExtjsPage extjsPage){
		...
		Map<String, Object> resultMap=this.roleService.findListByPage(role, extjsPage);
	...
	@ResponseBody
	public Map<String, Object> create(@RequestBody List<Role> list){
		Map<String, Object> map=new HashMap<>();
		for(Role role: list){
			role.preInsert();
	...
	@ResponseBody
	public Map<String, Object> update(@RequestBody List<Role> list){
		Map<String, Object> map=new HashMap<>();
		int flag=0;
		for(Role role: list){
	...
	@ResponseBody
	public Map<String, Object> destroy(@RequestBody List<Role> list){
		Map<String, Object> map=new HashMap<>();
		int count=0;
		for(Role role: list){
			count=count+this.roleService.deleteRole(role);
		}
	...
	public void exportExcel(HttpServletRequest req, HttpServletResponse resp, ModelMap model){
		...
		try {
			...
			String fileName=StringUtils.toUtf8String("Role_"+dateStr);
			//String fileName="Test";
			resp.setHeader("Content-Disposition","attachment;filename=\""+fileName+ ".xlsx\"");
			
			List<Map<String,Object>> fieldData=this.roleService.findMapList();
			Map<String,String> fieldName=new LinkedHashMap<String,String>();
			fieldName.put("roleId", "角色ID");
			fieldName.put("organizationId", "机构ID");
			fieldName.put("name", "角色名称");
			fieldName.put("role", "权限标识");
			fieldName.put("description", "描述");
			fieldName.put("available", "状态");
	...
	public void downloadTemplate(String model,HttpServletRequest req, HttpServletResponse resp){
		...
		try {
			...
			String fileName=StringUtils.toUtf8String("roleTemplate");
